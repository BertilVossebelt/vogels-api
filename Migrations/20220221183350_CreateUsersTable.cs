            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Password = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Honour = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    Ranking = table.Column<int>(type: "int", nullable: true),
                    Seeds = table.Column<int>(type: "int", nullable: true),
                    GoldenSeeds = table.Column<int>(type: "int", nullable: true),
